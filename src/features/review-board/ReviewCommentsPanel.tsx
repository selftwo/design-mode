...
function roleChip(annotation: BoardDocument['annotations'][number]): string | null {
  if (isTeachAnnotation(annotation)) return 'teach'
  if (isReviewAnnotation(annotation) && annotation.role === 'agent-question') return 'question'
  return null
}
      ...
      <div className="comments-rail-body">
        ...
        <ol className="comments-list">
          {document.annotations.map((annotation) => {
            ...
            const role = roleChip(annotation)
